...
$.ajax({
   ...
   for (var i = 0; i < results.length; i++) {
        ...
        if (results[i].title.includes("Software") || results[i].title.includes("Programming") || results[i].title.includes("App") || results[i].title.includes("Science") || results[i].title.includes("Science")) {
