...
const eventbriteSettings = {
    ...
    data: { token: 'NDTQNEDOWJ64E2QLDX2O', sort_by: 'date', 'location.address': 'Philadelphia', q : 'technology', subcategories : "2004", include_all_series_instances: "on", formats: "1,2,3,9,100" },
    crossDomain: true,
    method: 'GET'
}
    ...
    for (var i = 0; eventbriteEvents[i]; i++) {
       ...
       course.attr({
           "href": link,
            ...
            $("#eventbrite-technology").append(course); 
    }
